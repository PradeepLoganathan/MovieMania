...
using ParameterType = MovieMania.Core.Rest.ParameterType;
using RestClient = MovieMania.Core.Rest.RestClient;
using RestRequest = MovieMania.Core.Rest.RestRequest;
using MovieMania.Core.Exceptions;
using MovieMania.Core.Authentication;
using MovieMania.Core.Account;
...
namespace MovieMania.Core.Client
{
    public partial class MovieManiaClient
    {
        ...
        public MovieManiaClient(string apiKey, bool useSsl = false, string baseUrl = ProductionUrl, JsonSerializer serializer = null)
        {
